...
var Cone = function () {
  _createClass(Cone, [{
    ...
    value: function updateNormal(idx1, idx2, idx3) {
      ...
      (_normals = this.normals).push.apply(_normals, _toConsumableArray(norm).concat(_toConsumableArray(norm), _toConsumableArray(norm)));
    }
  }]);
...
var main = function main() {
  ...
  if (!u_ModelMatrix || !u_MvpMatrix || !u_NormalMatrix || !u_LightColor || !u_LightPosition || !u_AmbientLight || !u_DiffuseMat || !u_SpecularMat || !u_Shininess || !u_AmbientMat || !u_CameraPos || !u_modelChoice) {
